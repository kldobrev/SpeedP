...
static const unsigned char waves[] = {
    255,255,122,119,119,119,119,119,119,122,127,255,255,255,255,255,
...
const hUGESong_t speedpyoulose = {8, &order_cnt, order1, order2, order3,order4, duty_instruments, wave_instruments, noise_instruments, NULL, waves};
